...
export default function About() {
  return (
    <div className='columns is-centered'>
      <img src="../../../../assets/images/Shrauner.jpg" alt="Samantha with plant" width='250'  className='column is-one-third mx-2 is-centered'/>
      <div className='is-info column-is-one-third m-3 is-centered'>
        <h2>About Me</h2>
      <p>
